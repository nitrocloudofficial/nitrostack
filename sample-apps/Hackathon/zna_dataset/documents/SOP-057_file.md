# Standard Operating Procedure: ZNA SOP concerning ZNA Routine ROUTINE_AUDIT 80
**Document ID**: SOP-057
**Author**: Leslie Adams
**Date**: 2022-03-29
**Version**: 1.2 (Active)
...
## Procedure
1. Sync with V. White and log their weekly operational updates.
2. Confirm integration paths are aligned with M. Parsons's checklist.

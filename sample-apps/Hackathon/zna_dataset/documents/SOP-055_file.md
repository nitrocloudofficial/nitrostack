# Standard Operating Procedure: ZNA SOP concerning ZNA Routine ROUTINE_AUDIT 30
**Document ID**: SOP-055
**Author**: Michelle Ray
**Date**: 2021-03-05
**Version**: 1.2 (Active)
...
## Procedure
1. Sync with A. Baker and log their weekly operational updates.
2. Confirm integration paths are aligned with C. Dupont's checklist.

# Standard Operating Procedure: ZNA SOP concerning ZNA Routine ROUTINE_AUDIT 16
**Document ID**: SOP-062
...
## Procedure
1. Sync with Matthew and log their weekly operational updates.
2. Confirm integration paths are active on RabbitMQ message queue.

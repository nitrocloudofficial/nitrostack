...
export default function CalculatorResult() {
  ...
  const safe = {
    ...
    result: typeof data.result === 'number' ? data.result : 0,
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <span style={{ fontSize: '32px' }}>
            {getOperationIcon(safe.operation)}
          </span>
          <div>
            ...
            <p style={{ margin: '4px 0 0 0', fontSize: '14px', opacity: 0.7 }}>
              {safe.operation.charAt(0).toUpperCase() + safe.operation.slice(1)}
            </p>
          </div>
        </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {safe.expression || `${safe.a} → ${safe.result}`}
        </div>
        ...
        {state?.viewMode === 'detailed' && (
          <div style={{
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <div style={{ fontWeight: 'bold', fontSize: '20px' }}>{safe.a}</div>
            </div>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '12px', opacity: 0.7 }}>Second</div>
              <div style={{ fontWeight: 'bold', fontSize: '20px' }}>{safe.b}</div>
            </div>
            <div style={{ textAlign: 'center' }}>

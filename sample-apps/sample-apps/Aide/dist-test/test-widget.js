...
const mockOutput = {
    ...
    schedulingResult: { time: '2025-01-15T14:00:00Z', attendees: ['alice', 'bob'], duration: 60, confidence: 'high' },
    delegationResult: { taskId: 'task-001', owner: 'alice', deadline: '2025-01-17T17:00:00Z', priority: 'high', reasoning: 'Lowest workload' },
    adminResult: { approved: true, reason: 'Within policy', escalationRequired: false },
    finalMessage: { text: 'Meeting booked for Tuesday 2pm. Alice owns postmortem.', channel: '#incidents', format: 'slack' },
};

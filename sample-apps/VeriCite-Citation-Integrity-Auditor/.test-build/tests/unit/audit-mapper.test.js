...
describe('AuditMapper', () => {
    describe('buildSummary', () => {
        it('derives missingCitation from claims, not from verification results', () => {
            ...
            const summary = AuditMapper.buildSummary([claim('c1', ['cit_1']), claim('c2', ['cit_1']), claim('c3')], [citation('cit_1')], [result('c1', 'SUPPORTED'), result('c2', 'SUPPORTED'), result('c3', 'UNRELATED')]);
        ...
        it('counts citation resolution and retraction', () => {
            const summary = AuditMapper.buildSummary([claim('c1', ['a'])], [
        ...
        it('excludes ERROR results from average confidence', () => {
            const summary = AuditMapper.buildSummary([claim('c1', ['a']), claim('c2', ['a'])], [citation('a')], [
        ...
        it('tolerates null and undefined inputs', () => {
            const summary = AuditMapper.buildSummary(undefined, undefined, undefined);
...
//# sourceMappingURL=audit-mapper.test.js.map
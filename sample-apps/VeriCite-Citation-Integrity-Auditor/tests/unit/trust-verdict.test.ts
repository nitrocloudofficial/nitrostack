...
import type { AuditSummary, VerificationResult } from '../../src/shared/contracts.js';
...
const verdict = (score: number, s: Partial<AuditSummary> = {}, results: VerificationResult[] = []) =>
    TrustVerdictEngine.computeVerdict({
    ...
    describe('defensiveness', () => {
        it('survives malformed input', () => {
            const v = TrustVerdictEngine.computeVerdict({
                ...
                summary: undefined as unknown as AuditSummary,
                results: undefined as unknown as VerificationResult[],

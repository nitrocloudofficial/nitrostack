...
let SimulateLateralMovementTools = (() => {
    let _instanceExtraInitializers = [];
    let _simulateLateralMovement_decorators;
    return class SimulateLateralMovementTools {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _simulateLateralMovement_decorators = [Tool({
            ...
            __esDecorate(this, null, _simulateLateralMovement_decorators, { kind: "method", name: "simulateLateralMovement", static: false, private: false, access: { has: obj => "simulateLateralMovement" in obj, get: obj => obj.simulateLateralMovement }, metadata: _metadata }, null, _instanceExtraInitializers);
            if (_metadata) Object.defineProperty(this, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        }
        async simulateLateralMovement({ twin_id, attacker_profile, entry_point, simulation_duration_minutes }, ctx) {
            ...
            while (timeElapsed < simulation_duration_minutes) {
                ...
                const timeToCompromise = profile?.kill_chain.find((k) => k.phase === 'lateral-movement')?.typical_duration_minutes || 5;
...
export { SimulateLateralMovementTools };
